...
export default function Prices() {
  return (
    <section id="tarifs" className="py-20 px-4 sm:px-6 lg:px-8 bg-rosegold-dark/60 reveal">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {Object.entries(prices).map(([category, items]) => (
            <div key={category} className="bg-rosegold-dark/40 border border-gold/20 rounded-lg p-6">
