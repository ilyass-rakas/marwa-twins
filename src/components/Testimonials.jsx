...
export default function Testimonials() {
  return (
    <section id="temoignages" className="py-20 px-4 sm:px-6 lg:px-8 bg-rosegold-dark/40 reveal">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reviews.map((r) => (
            <div key={r.id} className="bg-rosegold-dark/60 border border-gold/20 rounded-lg p-6 text-left shadow-sm">
